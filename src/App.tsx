...
function App() {
  ...
  const [currentSpineAnimation, setCurrentSpineAnimation] =
    useState<string>("");
  const [currentAlienAnimation, setCurrentAlienAnimation] =
    useState<string>("");
    ...
    <div className="app">
      ...
      <div className="controls-panel">
        ...
        <div className="current-animation">
          <p>
            스파인보이: <strong>{currentSpineAnimation || "없음"}</strong>{" "}
            (스케일: {spineScale.toFixed(2)}) | 에일리언:{" "}
            <strong>{currentAlienAnimation || "없음"}</strong> (스케일:{" "}
